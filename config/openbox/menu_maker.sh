...
sed -i '/name="Exit"/ a\ \t\t\t\t<execute>~/.config/openbox/menu_exit_openbox.sh poweroff</execute>' ~/.config/openbox/menu.xml
sed -i '/name="Exit"/ a\ \t\t\t<item label="Power Off"> <action name="Execute">' ~/.config/openbox/menu.xml

sed -i '/name="Exit"/ a\ \t\t\t</action> </item>' ~/.config/openbox/menu.xml
sed -i '/name="Exit"/ a\ \t\t\t\t<execute>~/.config/openbox/menu_exit_openbox.sh reboot</execute>' ~/.config/openbox/menu.xml
