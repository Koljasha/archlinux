...
# fork Polywins https://github.com/tam-carre/polywins


# SETTINGS {{{ ---

active_text_color="#99d3ff"
active_bg=
active_underline="#55aa55"
...
separator="  "
show="window_full" # options: window_title, window_class, window_classname, window_full
